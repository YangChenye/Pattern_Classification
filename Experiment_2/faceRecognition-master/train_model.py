...
#建立一个基于CNN的人脸识别模型
class Model(object):
    FILE_PATH = "/Users/apple/Downloads/faceRecognition-master/model/model.h5"   #模型进行存储和读取的地方
    ...
    def train_model(self):
        ...
        self.model.fit(self.dataset.X_train,self.dataset.Y_train,epochs=7,batch_size=7)
...
if __name__ == '__main__':
    dataset = DataSet('/Users/apple/Downloads/faceRecognition-master/pictures/dataset')
    model = Model()
