...
def readPicSaveFace(sourcePath,objectPath,*suffix):
    try:
        ...
        count = 1
        face_cascade = cv2.CascadeClassifier('/usr/local/Cellar/opencv/3.4.1_4/share/OpenCV/haarcascades/haarcascade_frontalface_default.xml')
...
if __name__ == '__main__':
     readPicSaveFace('/Users/apple/Downloads/faceRecognition-master/pictures/source','/Users/apple/Downloads/faceRecognition-master/pictures/picTest','.jpg','.JPG','png','PNG')
